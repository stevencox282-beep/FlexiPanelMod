...
public class EntityStausIsDeadLogicHook
{
    ...
    private static void Prefix(EntityStatus.Logic __instance)
    {
        ...
        if (_timeSinceLastUpdate >= UpdateInterval)
        {
            ...
            // We must use TRY here, on zone change/exiting this API continues to fire despite everything being torn down around it, likely a bug in the game.
            // Perhaps I should not be using this API call but this is the best death notifications I can find
            try
            {
